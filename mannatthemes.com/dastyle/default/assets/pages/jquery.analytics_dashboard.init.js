var options = {
  ...
  series: [
    {
      name: "",
      data: [34, 22, 22.5, 26.5, 23, 31.5, 28, 31.5, 30, 33, 24, 30],
    },
    {
      name: "",
      data: [25, 36, 42, 50, 50, 42, 52, 45, 57, 47, 32, 31],
    },
  ],
  xaxis: {
    categories: [
    ...
    axisBorder: { show: !1, color: "#bec7e0" },
    axisTicks: { show: !1, color: "#bec7e0" },
  },
  legend: { offsetY: 6 },
  yaxis: { title: { text: "" } },
  fill: { opacity: 1 },
...
var dash_spark_1 = {
  chart: { type: "area", height: 25, sparkline: { enabled: !0 } },
  ...
  series: [{ data: [5, 10, 4, 16, 5, 11, 6, 11, 30, 10, 13, 4, 6] }],
  yaxis: { min: 0 },
  colors: ["#6374ff"],
  tooltip: { enabled: !1 },
};
...
var dash_spark_2 = {
  ...
  series: [{ data: [4, 8, 5, 10, 4, 25, 5, 11, 6, 11, 5, 10] }],
  yaxis: { min: 0 },
  colors: ["#6374ff"],
  tooltip: { enabled: !1 },
};
...
(chart = new ApexCharts(
  ...
  $("#usa").vectorMap({
    ...
    borderColor: "#818181",
    regionStyle: { initial: { fill: "#2a76f428" } },
    series: {
      regions: [
        {
          values: {
