...
for (
  var ts2 = 14844186e5, dates = [], spikes = [5, -5, 3, -3, 8, -8], i = 0;
  i < 120;
  i++
) {
  ...
  $(document).ready(function () {
          ...
          yaxis: [
            {
              ...
              label: {
                show: !0,
                text: "Support",
                style: { color: "#fff", background: "#03d87f" },
              },
            },
          ],
          xaxis: [
            {
              ...
              label: {
                show: !0,
                text: "Rally",
                style: { color: "#fff", background: "#ffb822" },
              },
            },
          ],
        },
    ...
    document
      ...
      document.querySelector("#all").addEventListener("click", function (e) {
        a(e), t.updateOptions({ xaxis: { min: void 0, max: void 0 } });
      }),
...
options = {
  ...
  xaxis: {
    ...
    position: "top",
    labels: { offsetY: -18 },
    axisBorder: { show: !0, color: "#28365f" },
    axisTicks: { show: !0, color: "#28365f" },
    crosshairs: {
      fill: {
        type: "gradient",
        gradient: {
  ...
  grid: {
    row: { colors: ["#afb7d21a", "transparent"], opacity: 0.2 },
    borderColor: "#f1f3fa",
  },
};
(chart = new ApexCharts(
...
options = {
  chart: { height: 320, type: "candlestick", toolbar: { show: !1 } },
  series: [
    {
      data: [
...
options = {
  ...
  plotOptions: {
    radialBar: {
      startAngle: -135,
      endAngle: 135,
      track: { background: "#b9c1d4", opacity: 0.3 },
      dataLabels: {
        name: { fontSize: "16px", color: "#8997bd", offsetY: 120 },
        value: {
          offsetY: 76,
          fontSize: "22px",
          color: "#8997bd",
...
var randomizeArray = function (e) {
  ...
  spark1 = {
    ...
    fill: { opacity: 0.2 },
    series: [{ name: "Metrica Sales ", data: randomizeArray(sparklineData) }],
    yaxis: { min: 0 },
    colors: ["#f93b7a"],
    title: {
      text: "$424,652",
      offsetX: 20,
      style: { fontSize: "24px", color: "#8997bd", fontWeight: "500" },
    },
    subtitle: {
      text: "Sales",
      offsetX: 20,
      style: { fontSize: "14px", color: "#8997bd" },
    },
  };
...
var spark2 = {
  ...
  stroke: { width: 2, curve: "straight" },
  fill: { opacity: 0.2 },
  series: [{ name: "Metrica Expenses ", data: randomizeArray(sparklineData) }],
  yaxis: { min: 0 },
  colors: ["#fbb624"],
  title: {
    text: "$235,312",
